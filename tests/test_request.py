...
class TestHTTPClient(unittest.TestCase):
    ...
    parser.add_argument(
        "-v", "--verbose", action="store_true", help="detailed response"
    )
    ...
    def test_check_get_request(self):
        ...
        self.assertEqual(
            "GET /t/lp5td-1586273836/post HTTP/1.1\r\n"
            "Host: ptsv2.com\r\n"
            "Connection: close\r\n\r\n",
            request.request,
        )
    ...
    def test_check_post_request_text(self):
        args = self.parser.parse_args(
            [
                "-d",
                "Hello, World!",
                "http://ptsv2.com/t/lp" "5td-1586273836/post",
                "-r",
                "POST",
            ]
        )
        ...
        request.make_request()
        self.assertEqual(
            "POST /t/lp5td-1586273836/post HTTP/1.1\r\n"
            "Host: ptsv2.com\r\n"
            "Connection: close\r\n"
            "Content-Length: 13\r\n\r\n"
            "Hello, World!",
        ...
        self.assertEqual(
            {
                "Server": "VK",
                "Connection": "close",
                "Content-Type": "text/h" "tml; charset=UTF-8",
            },
    ...
    def test_prepare_headers(self):
        args = self.parser.parse_args(
            [
                "http://ptsv2.com/t/lp5" "td-1586273836/post",
                "-H",
                "Content-Length: 30",
                "Pory: tau",
                "-e",
